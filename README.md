...
- **Binary Container** - Custom container data structure implementation
- **Circular Linked List** - Implements circular linked list with operations
- **Mersenne Primes** - Calculates and validates Mersenne prime numbers
